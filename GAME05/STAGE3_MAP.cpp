...
namespace GAME05 {
    void MAP3::setImage(int Img, int gImg) {
        StageImage = Img;
        GoalImage = gImg;
    }
    void MAP3::setMusic(int Music) {
        StageMusic = Music;
    }
    void MAP3::playMusic() {
    ...
    void MAP3::for_MAP3_LOAD() {
        fileName = "..\\MAIN\\assets\\game05\\stage3_map.txt";
    }
    void MAP3::for_MAP3_INIT() {
        blockSize = 100;
        display_Cols = (width / blockSize) + 1.0f;
        endWorldX = blockSize * (cols - 2) - width;
    }
    void MAP3::RESTART_MAP3() {
    ...
    void MAP3::MAP3FILE_OPEN_etc_MEMORY_ALLOCATION(FILE** fp_pointer) {
    ...
    void MAP3::PLAYER_MAP3_COLLISION(class PLAYER* p_pointer, class GAME_STRUCT* g_pointer) {
        noStroke();
        start_Cols = worldX / blockSize;
        end_Cols = start_Cols + display_Cols;
        for (int c = start_Cols; c < end_Cols; c++) {
